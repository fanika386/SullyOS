          ...
          <div className="absolute top-12 left-0 w-full flex flex-col items-center gap-2 pointer-events-none z-[60]">
              {toasts.map(toast => (
                 <div
                    ...
                    className={`animate-fade-in bg-white/95 backdrop-blur-xl px-4 py-3 rounded-2xl shadow-xl border border-black/5 flex items-start gap-3 max-w-[85%] ring-1 ring-white/20 ${toast.onClick ? 'pointer-events-auto cursor-pointer active:scale-[0.98] transition-transform' : ''}`}
                 >
